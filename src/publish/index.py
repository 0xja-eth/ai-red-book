...
PUBLISHERS = {
  ...
  ("%s_%s" % (Platform.XHS.value, GenerateType.Video.value)): xhs_video_pyppeteer.publisher,
  ("%s_%s" % (Platform.DY.value, GenerateType.Video.value)): dy_video_pyppeteer.publisher,
