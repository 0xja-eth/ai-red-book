...
class Request:
  ...
  def get(self, route, data): return self._request("GET", route, data)
  def post(self, route, data): return self._request("POST", route, data)
  def delete(self, route, data): return self._request("DELETE", route, data)
  def put(self, route, data): return self._request("PUT", route, data)
